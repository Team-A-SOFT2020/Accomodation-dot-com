...
.syntax--markdown .syntax--link .syntax--string {
  color: #888;
        ...
        <body class='markdown-preview' data-use-github-style><p><em>LSD Project, <a href="https://datsoftlyngby.github.io/soft2020fall/resources/da1526ac-case-4.pdf">case 4</a></em></p>
<h1 id="accomodation-dot-com"><strong>Accomodation-dot-com</strong></h1>
...
<tr>
<td align="left">Third party solution</td>
<td align="center"></td>
</tr>
<tr>
...
<tr>
<td align="left">Travel agency</td>
<td align="center">x</td>
</tr>
<tr>
...
<tr>
<td align="left">Five letter code</td>
<td align="center">x</td>
</tr>
<tr>
...
<tr>
<td align="left">6 digit number</td>
<td align="center">x</td>
</tr>
<tr>
...
<tr>
<td align="left">distance to center</td>
<td align="center">x</td>
</tr>
<tr>
<td align="left">star ratings</td>
<td align="center">x</td>
</tr>
<tr>
<td align="left">Number rooms</td>
<td align="center">x</td>
</tr>
<tr>
...
<tr>
<td align="left">digits and Optional letter a-z</td>
<td align="center">x</td>
</tr>
<tr>
...
<tr>
<td align="left">S single</td>
<td align="center">?</td>
</tr>
<tr>
<td align="left">D double</td>
<td align="center">?</td>
</tr>
<tr>
<td align="left">T twin</td>
<td align="center">?</td>
</tr>
<tr>
...
<tr>
<td align="left">M meeting room</td>
<td align="center">?</td>
</tr>
<tr>
<td align="left">individual Price</td>
<td align="center">x</td>
</tr>
<tr>
...
<tr>
<td align="left">Adult guest</td>
<td align="center">x</td>
</tr>
<tr>
<td align="left">Child guest</td>
<td align="center">x</td>
</tr>
<tr>
...
<tr>
<td align="left">Vacant hotel room</td>
<td align="center">x</td>
</tr>
<tr>
<td align="left">City</td>
...
<h2 id="logical-data-model"><strong>Logical Data Model</strong></h2>
<details>
  <summary>Click to expand!</summary>

<p><img alt="alt text" src="https://github.com/maleneH/LSD--TeamA/blob/master/LDM.png"></p>
<p>This model describes a booking system in which a ”Guest” can book one or multiple vacant rooms with 1 or multiple nr of guests attached.
...
“TravelAgency” and “Employee” are displayed and greyed out for future implementation.</p>
<p>This model describes a booking system in which a ”Guest” can book one or multiple vacant rooms with 1 or multiple nr of guests.
...
<h2 id="use-case-diagram"><strong>Use Case Diagram</strong></h2>
<details>
  <summary>Click to expand!</summary>

<p><img alt="alt text" src="https://github.com/maleneH/LSD--TeamA/blob/master/UCD.png"></p>
</details>

<h2 id="use-cases-and-sequence-diagrams"><strong>Use Cases and Sequence Diagrams</strong></h2>
<br>
...
<p>  <strong>Name:</strong> Show list of vacant rooms</p>
<p><strong>Description:</strong> Show a list of vacant rooms</p>
<p><strong>Primary Actor:</strong> Guest</p>
<p><strong>Preconditions:</strong> none</p>
<p><strong>Main Succes Scenario:</strong></p>
<ol>
<li>Guest selects city, date and number of guests</li>
<li>System shows list of hotels with vacant rooms</li>
<li>Guest selects a hotel</li>
<li>System shows list of vacant rooms</li>
</ol>
<br>

<p><strong>Extensions:</strong></p>
<p><strong>2a:</strong> No hotels have vacant rooms that meet (all) the criteria.</p>
<ol>
<li>System displays "No vacant rooms are available error"</li>
<li>Guest returns to MSS 1</li>
</ol>
<p><strong>4a:</strong> Hotel no longer has available room(s)</p>
<ol>
<li>System displays "Hotel is no longer available error"</li>
<li>Guest returns to MSS 3</li>
</ol>
<p><strong>Postcondition (Success guaranties)</strong> A list of vacant rooms is displayed</p>
<p><img alt="alt text" src="https://github.com/maleneH/LSD--TeamA/blob/master/Sequence%20Diagrams/SD_UseCase1.png"></p>
<h3 id="uc2">UC2</h3>
<br>

<p><strong>Name:</strong> Create Booking</p>
<p><strong>Description:</strong> Create a booking</p>
<p><strong>Primary Actor:</strong> Guest</p>
<p><strong>Preconditions:</strong> none</p>
<p><strong>Main Succes Scenario:</strong></p>
<ol>
<li><p>Guest searches for list of vacant rooms (UC1)</p>
</li>
<li><p>Guest selects room to book</p>
</li>
<li><p>System asks for passport number</p>
</li>
<li><p>Guest fills in passport number and confirms booking</p>
</li>
<li><p>System confirms booking</p>
</li>
</ol>
<p><strong>Extensions:</strong></p>
<p><strong>2a:</strong> Room is no longer available</p>
<ol>
<li>System displays “Room unavailable error”</li>
<li>System updates list of vacant rooms</li>
<li>Guest returns to MSS 2</li>
</ol>
<p><strong>Postcondition (Success guaranties)</strong> A room is booked</p>
<p><img alt="alt text" src="https://github.com/maleneH/LSD--TeamA/blob/master/Sequence%20Diagrams/SD_UseCase2.png"></p>
<h3 id="uc3">UC3</h3>
<br>

<p><strong>Name:</strong> Show booking</p>
<p><strong>Description:</strong> Show bookings made by the guest</p>
<p><strong>Primary Actor:</strong> Guest</p>
<p><strong>Preconditions:</strong> none</p>
<p><strong>Main Succes Scenario:</strong></p>
<ol>
<li><p>Guest fills in booking id</p>
</li>
<li><p>System shows booking details</p>
</li>
</ol>
<p><strong>Postcondition (Success guaranties)</strong> Bookings made my guest is displayed.</p>
<h3 id="uc4">UC4</h3>
<br>

<p><strong>Name:</strong> Cancel Booking</p>
<p><strong>Description:</strong> Cancels a booking</p>
<p><strong>Primary Actor:</strong> Guest</p>
<p><strong>Preconditions:</strong> none</p>
<p><strong>Main Succes Scenario:</strong></p>
<ol>
<li><p>System displays current bookings (UC3)</p>
</li>
<li><p>Guest selects room to cancel</p>
</li>
<li><p>System confirms cancelation</p>
</li>
</ol>
<p><strong>Postcondition (Success guaranties)</strong> A room is canceled</p>
</details></body>
      </html>
